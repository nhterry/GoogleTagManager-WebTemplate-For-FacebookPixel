...
{
  "displayName": "Facebook Pixel - Country, FBP, FBC",
  ...
  "version": 1,
  "brand": {
    "displayName": "Nick Terry",
    "id": "facebook_pixel_fixes",
        ...
        "simpleTableColumns": [
          {
            "selectItems": [
              ...
              {
                "displayValue": "FBP - Browser ID",
                "value": "fbp"
              },
              {
                "displayValue": "FBC - Click ID",
                "value": "fbc"
              }
            ],
            "defaultValue": "",
...
setup: "const mockData = {\n  pixelId: '12345,23456',\n  eventName: 'standard',\n\
  ...
  \ [{name: 'ct', value: 'Helsinki'},{name: 'country', value: 'Finland'},{name: 'external_id',\
  \ value: 'UserId'},{name: 'fbp', value: 'FBP'},{name: 'fbc', value: 'FBC'}],\n  objectPropertiesFromVariable: false,\n  objectPropertyList:\
